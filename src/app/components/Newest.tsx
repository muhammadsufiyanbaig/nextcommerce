...
const Newest = async () => {
  const data: smiplifiedproduct[] = await getData();
  return (
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className='mx-auto max-w-screen-2xl px-4 md:px-8'>
      <div className="mb-10 md:mb-16">
      <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Our Products</h2>
    ...
    <Link 
    className='flex justify-center items-center mt-3 text-xl font-bold text-primary '
    href={''}>
      See All
    </Link>
    </div>
